...
保持踏实的学习节奏，注重课堂听讲与课后巩固，按时高质量完成各科作业与考核。课余积极参与学科竞赛与实践活动，综合表现良好，2次获评校级奖学金。
...
任职期间认真负责班级社团日常事务，及时传达学院通知与安排，积极组织班级活动与学风建设，主动协调解决同学困难，工作踏实细致，获得师生认可，获评信息科学与工程学部优秀学生干部。
...
#item(
  link(
    "https://github.com/UoB-COMSM0166/2026-group-10",
    [ *使用P5.js的塔防游戏* ]
  ),
  [ *课程项目* ],
  date[ 2026 年 01 月 – 2026 年 05 月 ]
)

#tech[ _P5.js, JavaScript, Web开发与调试_ ]

基于P5.js的交互式可视化塔防游戏，实现了敌人生成，英雄控制，游戏胜负判定等功能。

- 基于OOP设计的单位和实体，以及各自的移动速度、BUFF、死亡逻辑，还有经济系统
- 敌人的移动路径、技能判定以及“亡语”效果。Boss的多阶段行为逻辑和技能释放
- 英雄的技能施放、弹道计算、技能冷却和伤害判定。通过技能树和升级系统实现英雄成长
- 使用P5.js实现了游戏的渲染和交互

#item(
  link(
    "https://github.com/Shadow-Song/Nullspace",
    [ *BATDiff和DIP的零空间整合* ]
  ),
  [ *毕业设计* ],
  date[ 2026 年 01 月 – 2026 年 09 月 ]
)

#tech[ _图像处理, 机器学习, Python, PyTorch_ ]

整合了BATDiff和Deep Image Prior两种技术，实现了图像修复与重建等功能。

- 增加了BATDiff和DIP算法的Score融合机制，提高了图像修复的准确性和鲁棒性
- 使用统一的 Lanczos2 退化模型描述高分辨率图像到低分辨率观测的映射
- 反向扩散过程中，算法结合 DIP 与扩散模型的干净图像估计，再执行数据一致性校正
- 使用Python和PyTorch实现算法并进行实验验证，取得了良好的实验结果
