...
#let resume(
	...
	show heading.where(level: 1): set text(font: th("font-title"), weight: "light")

	set text(font: th("font-text"), size: th("font-size"), fill: th("text-color"))
			...
			{
				{
					...
					show heading: set text(size: 12pt, weight: "regular", font: th("font-text"), fill: th("text-color"))
					heading(level: 2, first-name)
				}
				{
					show heading: set block(above: 3pt, below: 0pt)
					show heading: set text(size: 26pt, weight: "regular", font: th("font-text"), fill: th("text-color"))

					heading(level: 1, last-name)
				}
				{
					show heading: set block(above: 10pt, below: 0pt)
					show heading: set text(weight: "light", font: th("font-mono"))
				...
				set text(weight: "light", hyphenate: true)
...
#let python-icon = image("images/python.svg")
#let swift-icon = image("images/swift.svg")
#let ios-icon = image("images/ios.svg")
#let java-icon = image("images/java.svg")
#let linux-icon = image("images/linux.svg")
#let assembly-icon = image("images/assembly.svg")
